...
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: 'pages/__layout.svelte-77ec3fc8.js',
		css: ['assets/pages/__layout.svelte-ecc1a177.css', 'assets/vendor-7104a7ff.css'],
		js: [
			'pages/__layout.svelte-77ec3fc8.js',
	...
	'src/routes/index.svelte': {
		entry: 'pages/index.svelte-39e52d4f.js',
		css: ['assets/vendor-7104a7ff.css'],
		js: ['pages/index.svelte-39e52d4f.js', 'chunks/vendor-be7a8b85.js'],
		styles: []
	},
	'src/routes/projects.svelte': {
		entry: 'pages/projects.svelte-b981d9d5.js',
		css: ['assets/pages/projects.svelte-03752716.css', 'assets/vendor-7104a7ff.css'],
		js: ['pages/projects.svelte-b981d9d5.js', 'chunks/vendor-be7a8b85.js'],
		styles: []
	},
	'src/routes/flowers.svelte': {
		entry: 'pages/flowers.svelte-4e267465.js',
		css: ['assets/pages/flowers.svelte-ca3bc844.css', 'assets/vendor-7104a7ff.css'],
		js: ['pages/flowers.svelte-4e267465.js', 'chunks/vendor-be7a8b85.js'],
		styles: []
	},
	'src/routes/blog/secondpost.md': {
...
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	<div class="${'flex-1 flex md:justify-end'}"><a class="${'pr-4 svelte-lb38hl'}" href="${'/flowers'}"><span class="${[
		'svelte-lb38hl',
		$page.path.includes('/flowers') ? 'active' : ''
	]
		.join(' ')
		.trim()}">Florals</span><span class="${'emoji pl-4 svelte-lb38hl'}">\u{1F338}</span></a>
		<a class="${'px-4 svelte-lb38hl'}" href="${'/projects'}"><span class="${[
		'svelte-lb38hl',
		$page.path.includes('/projects') ? 'active' : ''
	]
		.join(' ')
		.trim()}">Projects</span><span class="${'emoji pl-4 svelte-lb38hl'}">\u{1F5C2}</span></a></div>
</nav>`;
});
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `${validate_component(Seo, 'Seo').$$render($$result, {}, {}, {})}
<div class="${'body-wrapper container mx-auto'}">${validate_component(Nav, 'Nav').$$render(
		$$result,
		{},
		{},
		{}

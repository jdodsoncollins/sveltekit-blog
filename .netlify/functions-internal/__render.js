...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "bg.jpg", "size": 117281, "type": "image/jpeg" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "resume.pdf", "size": 78137, "type": "application/pdf" }, { "file": "robots.txt", "size": 67, "type": "text/plain" }],
...
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="${"pb-8 flex flex-col md:flex-row items-center"}"><div class="${"flex-1"}"><a href="${"/"}" class="${"svelte-rjamyi"}"><div class="${"logo-wrapper svelte-rjamyi"}"><h1 class="${"logo pr-4 text-3xl svelte-rjamyi"}">Bethany Collins</h1></div></a></div>
	<div class="${"flex-1 flex md:justify-end"}"><a class="${"pr-4 font-display svelte-rjamyi"}" href="${"/flowers"}"><span class="${["svelte-rjamyi", $page.path.includes("/flowers") ? "active" : ""].join(" ").trim()}">Florals</span><span class="${"emoji pl-4 svelte-rjamyi"}">\u{1F338}</span></a>
		<a class="${"px-4 font-display svelte-rjamyi"}" href="${"/projects"}"><span class="${["svelte-rjamyi", $page.path.includes("/projects") ? "active" : ""].join(" ").trim()}">Projects</span><span class="${"emoji pl-4 svelte-rjamyi"}">\u{1F5C2}</span></a></div>
</nav>`;
});
var css$c = {
...
<div class="${"body-wrapper container mx-auto svelte-1727yap"}">${validate_component(Nav, "Nav").$$render($$result, {}, {}, {})}
...
<h2 class="${"pt-8"}">Behind the Scenes Look!</h2>
<div class="${"horizontal-snap svelte-1pcdv89"}">${each(makings, (making) => `<img${add_attribute("src", making, 0)} alt="${"Behind the Scenes Flower Making"}" class="${"svelte-1pcdv89"}">`)}</div>
${validate_component(Lightbox, "Lightbox").$$render($$result, { isVisible: !!selectedImg }, {}, {
    default: () => `<img${add_attribute("src", selectedImg, 0)}>`
  })}`;
});

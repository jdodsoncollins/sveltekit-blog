	...
	'node_modules/vanilla-lazyload/dist/lazyload.min.js'(exports, module2) {
		...
		!(function (n, t) {
			typeof exports == 'object' && typeof module2 != 'undefined'
				...
				? define(t)
				: ((n = typeof globalThis != 'undefined' ? globalThis : n || self).LazyLoad = t());
		})(exports, function () {
			'use strict';
			function n() {
				return (
			...
			var t = typeof window != 'undefined',
				...
				u = function (n2, t2) {
					var e2,
						i2 = 'LazyLoad::Initialized',
						o2 = new n2(t2);
					try {
						e2 = new CustomEvent(i2, { detail: { instance: o2 } });
					} catch (n3) {
						(e2 = document.createEvent('CustomEvent')).initCustomEvent(i2, false, false, {
							instance: o2
						});
					}
				...
				C = function (n2, t2) {
					o
						? n2.classList.remove(t2)
						: (n2.className = n2.className
								.replace(new RegExp('(^|\\s+)' + t2 + '(\\s+|$)'), ' ')
								.replace(/^\s+/, '')
								.replace(/\s+$/, ''));
				},
				M = function (n2) {
				...
				K = function (n2, t2) {
					J(n2, f, I(n2, t2.data_sizes)),
						J(n2, s2, I(n2, t2.data_srcset)),
						J(n2, l, I(n2, t2.data_src));
				},
				Q = {
					IMG: function (n2, t2) {
						D(n2, function (n3) {
				...
				en = function (n2, t2, e2) {
					!(function (n3) {
						...
						C(n2, t2.class_loading),
						t2.unobserve_completed && z(n2, e2);
				},
						...
						(function (n3, t3, e3) {
							...
							function (o2) {
								!(function (n3, t3, e3, i3) {
									var o3 = w(t3);
									en(t3, e3, i3),
										N(t3, e3.class_loaded),
										A(t3, v),
										O(e3.callback_loaded, t3, i3),
										o3 || X(e3, i3);
								})(0, n2, t2, e2),
									tn(i2);
							},
				...
				an = function (n2, t2, e2) {
					!(function (n3) {
						...
						(function (n3, t3, e3) {
							var i2 = I(n3, t3.data_bg),
								o2 = I(n3, t3.data_bg_hidpi),
								r2 = a && o2 ? o2 : i2;
							r2 &&
								((n3.style.backgroundImage = 'url("'.concat(r2, '")')),
								M(n3).setAttribute(l, r2),
								B(n3, t3, e3));
						})(n2, t2, e2),
						(function (n3, t3, e3) {
							var i2 = I(n3, t3.data_bg_multi),
								o2 = I(n3, t3.data_bg_multi_hidpi),
								r2 = a && o2 ? o2 : i2;
							r2 &&
								((n3.style.backgroundImage = r2),
								(function (n4, t4, e4) {
									N(n4, t4.class_applied),
										A(n4, b),
										e4 && (t4.unobserve_completed && z(n4, t4), O(t4.callback_applied, n4, e4));
								})(n3, t3, e3));
						})(n2, t2, e2);
				},
				...
				sn = function (n2, t2) {
					(function (n3) {
						...
						(function (n3, t3) {
							L(n3) ||
								w(n3) ||
								(C(n3, t3.class_entered),
								C(n3, t3.class_exited),
								C(n3, t3.class_applied),
								C(n3, t3.class_loading),
								C(n3, t3.class_loaded),
								C(n3, t3.class_error));
						})(n2, t2),
						k(n2),
						$(n2);
				...
				_n = function (n2, t2, e2) {
					n2.forEach(function (n3) {
						return (function (n4) {
							...
							? (function (n4, t3, e3, i2) {
									var o2 = (function (n5) {
										return x.indexOf(y(n5)) >= 0;
									})(n4);
									A(n4, 'entered'),
										N(n4, e3.class_entered),
										C(n4, e3.class_exited),
										(function (n5, t4, e4) {
											t4.unobserve_entered && z(n5, e4);
										})(n4, e3, i2),
										O(e3.callback_enter, n4, t3, i2),
										o2 || rn(n4, e3, i2);
							  })(n3.target, n3, t2, e2)
							: (function (n4, t3, e3, i2) {
									L(n4) ||
										(N(n4, e3.class_exited),
										(function (n5, t4, e4, i3) {
											e4.cancel_on_exit &&
												(function (n6) {
													return y(n6) === g;
												})(n5) &&
												...
												un(n5),
												C(n5, e4.class_loading),
												R(i3, -1),
												k(n5),
												O(e4.callback_cancel, n5, t4, i3));
										})(n4, t3, e3, i2),
										O(e3.callback_exit, n4, t3, i2));
							  })(n3.target, n3, t2, e2);
					});
				},
				gn = function (n2) {
				...
				hn = function (n2, e2) {
					...
					(this._settings = o2),
						...
						(function (n3, t2) {
							i &&
								!dn(n3) &&
								(t2._observer = new IntersectionObserver(
									function (e3) {
										_n(e3, n3, t2);
									},
									(function (n4) {
										return {
											root: n4.container === document ? null : n4.container,
											rootMargin: n4.thresholds || n4.threshold + 'px'
										};
									})(n3)
								));
						})(o2, this),
			...
			return (
				(hn.prototype = {
								...
								? dn(a2)
									? (function (n3, t3, e2) {
											n3.forEach(function (n4) {
												fn.indexOf(n4.tagName) !== -1 &&
													(function (n5, t4, e3) {
														n5.setAttribute('loading', 'lazy'),
															on(n5, t4, e3),
															(function (n6, t5) {
																var e4 = Q[n6.tagName];
																e4 && e4(n6, t5);
					...
					destroy: function () {
						this._observer && this._observer.disconnect(),
							vn(this._settings).forEach(function (n2) {
								$(n2);
							}),
				...
				t &&
					(function (n2, t2) {
						if (t2)
							if (t2.length) for (var e2, i2 = 0; (e2 = t2[i2]); i2 += 1) u(n2, e2);
							else u(n2, t2);
...
var template = ({ head, body }) =>
	'<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="/favicon.ico" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		<link rel="preconnect" href="https://fonts.googleapis.com">\n		<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>\n		<link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Oleo+Script+Swash+Caps:wght@400;700&display=swap" rel="stylesheet">\n		' +
	head +
	'\n	</head>\n	<body>\n		<div id="svelte">' +
	body +
	'</div>\n	</body>\n</html>\n';
...
function init(settings = default_settings) {
	...
	options = {
		...
		dev: false,
		entry: {
			file: assets + '/_app/start-742fc10c.js',
			css: [
				assets + '/_app/assets/start-464e9d0a.css',
				assets + '/_app/assets/vendor-7104a7ff.css'
			],
			js: [assets + '/_app/start-742fc10c.js', assets + '/_app/chunks/vendor-be7a8b85.js']
		},
		fetched: void 0,
		floc: false,
...
var manifest = {
	assets: [
		{ file: 'bg.jpg', size: 117281, type: 'image/jpeg' },
		{ file: 'favicon.png', size: 1571, type: 'image/png' },
		{ file: 'resume.pdf', size: 78137, type: 'application/pdf' },
...
var module_lookup = {
	...
	'src/routes/flowers.svelte': () =>
		Promise.resolve().then(function () {
			return flowers;
		}),
	'src/routes/blog/secondpost.md': () =>
		Promise.resolve().then(function () {
			return secondpost;
		}),
	'src/routes/blog/third-post.svx': () =>
		Promise.resolve().then(function () {
			return thirdPost;
		}),
	'src/routes/blog/firstpost.md': () =>
		Promise.resolve().then(function () {
			return firstpost;
		}),
...
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: 'pages/__layout.svelte-4b0e687f.js',
		css: ['assets/pages/__layout.svelte-033e8765.css', 'assets/vendor-7104a7ff.css'],
		js: [
			'pages/__layout.svelte-4b0e687f.js',
			'chunks/vendor-be7a8b85.js',
			'chunks/store-b55c7585.js'
		],
		styles: []
	},
	'.svelte-kit/build/components/error.svelte': {
		entry: 'error.svelte-7c6cd74f.js',
		css: ['assets/vendor-7104a7ff.css'],
		js: ['error.svelte-7c6cd74f.js', 'chunks/vendor-be7a8b85.js'],
		styles: []
	},
	'src/routes/index.svelte': {
		entry: 'pages/index.svelte-b98d4488.js',
		css: ['assets/vendor-7104a7ff.css'],
		js: ['pages/index.svelte-b98d4488.js', 'chunks/vendor-be7a8b85.js'],
		styles: []
	},
	'src/routes/projects.svelte': {
		entry: 'pages/projects.svelte-efe5f662.js',
		css: ['assets/pages/projects.svelte-03752716.css', 'assets/vendor-7104a7ff.css'],
		js: ['pages/projects.svelte-efe5f662.js', 'chunks/vendor-be7a8b85.js'],
		styles: []
	},
	'src/routes/flowers.svelte': {
		entry: 'pages/flowers.svelte-f751640e.js',
		css: ['assets/pages/flowers.svelte-ca3bc844.css', 'assets/vendor-7104a7ff.css'],
		js: ['pages/flowers.svelte-f751640e.js', 'chunks/vendor-be7a8b85.js'],
		styles: []
	},
	'src/routes/blog/secondpost.md': {
		entry: 'pages/blog/secondpost.md-4c44555f.js',
		css: ['assets/vendor-7104a7ff.css', 'assets/BlogLayout-564f10bb.css'],
		js: [
			'pages/blog/secondpost.md-4c44555f.js',
			'chunks/vendor-be7a8b85.js',
			'chunks/BlogLayout-0a40b42a.js',
			'chunks/store-b55c7585.js'
		],
		styles: []
	},
	'src/routes/blog/third-post.svx': {
		entry: 'pages/blog/third-post.svx-d4315668.js',
		css: ['assets/vendor-7104a7ff.css', 'assets/BlogLayout-564f10bb.css'],
		js: [
			'pages/blog/third-post.svx-d4315668.js',
			'chunks/vendor-be7a8b85.js',
			'chunks/BlogLayout-0a40b42a.js',
			'chunks/store-b55c7585.js'
		],
	...
	'src/routes/blog/firstpost.md': {
		entry: 'pages/blog/firstpost.md-88437b0f.js',
		css: ['assets/vendor-7104a7ff.css', 'assets/BlogLayout-564f10bb.css'],
		js: [
			'pages/blog/firstpost.md-88437b0f.js',
			'chunks/vendor-be7a8b85.js',
			'chunks/BlogLayout-0a40b42a.js',
			'chunks/store-b55c7585.js'
		],
	...
	'src/routes/blog.svelte': {
		entry: 'pages/blog.svelte-31107acd.js',
		css: ['assets/vendor-7104a7ff.css'],
		js: ['pages/blog.svelte-31107acd.js', 'chunks/vendor-be7a8b85.js', 'chunks/store-b55c7585.js'],
		styles: []
	}
};
...
async function get() {
	...
	for (const path in imports) {
		body.push(
			imports[path]().then(({ metadata: metadata2 }) => {
				return {
					metadata: metadata2,
					path
				};
...
var Seo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${
		(($$result.head += `${
			(($$result.title = `<title>${escape($seo.title)}</title>`), '')
		}<meta name="${'description'}"${add_attribute(
			'content',
			$seo.description,
			0
		)} data-svelte="svelte-135fyrd">`),
		'')
	}`;
});
var getStores = () => {
...
var css$d = {
	code: '.emoji.svelte-rjamyi.svelte-rjamyi{font-size:1.5em}.logo.svelte-rjamyi.svelte-rjamyi,.logo-wrapper.svelte-rjamyi.svelte-rjamyi{display:inline}.logo.svelte-rjamyi.svelte-rjamyi{font-weight:700}a.svelte-rjamyi.svelte-rjamyi{align-items:center;display:flex}a.svelte-rjamyi .active.svelte-rjamyi{text-decoration:underline}',
	map: `{"version":3,"file":"Nav.svelte","sources":["Nav.svelte"],"sourcesContent":["<script>\\n\\timport { page } from '$app/stores';\\n<\/script>\\n\\n<nav class=\\"pb-8 flex flex-col md:flex-row items-center\\">\\n\\t<div class=\\"flex-1\\">\\n\\t\\t<a href=\\"/\\"><div class=\\"logo-wrapper\\"><h1 class=\\"logo pr-4 text-3xl\\">Bethany Collins</h1></div></a>\\n\\t</div>\\n\\t<div class=\\"flex-1 flex md:justify-end\\">\\n\\t\\t<a class=\\"pr-4 font-display\\" href=\\"/flowers\\"\\n\\t\\t\\t><span class:active={$page.path.includes('/flowers')}>Florals</span><span class=\\"emoji pl-4\\"\\n\\t\\t\\t\\t>\u{1F338}</span\\n\\t\\t\\t></a\\n\\t\\t>\\n\\t\\t<a class=\\"px-4 font-display\\" href=\\"/projects\\"\\n\\t\\t\\t><span class:active={$page.path.includes('/projects')}>Projects</span><span class=\\"emoji pl-4\\"\\n\\t\\t\\t\\t>\u{1F5C2}</span\\n\\t\\t\\t></a\\n\\t\\t>\\n\\t</div>\\n</nav>\\n\\n<style lang=\\"scss\\">.emoji{font-size:1.5em}.logo,.logo-wrapper{display:inline}.logo{font-weight:700}a{align-items:center;display:flex}a .active{text-decoration:underline}</style>\\n"],"names":[],"mappings":"AAsBmB,kCAAM,CAAC,UAAU,KAAK,CAAC,iCAAK,CAAC,yCAAa,CAAC,QAAQ,MAAM,CAAC,iCAAK,CAAC,YAAY,GAAG,CAAC,6BAAC,CAAC,YAAY,MAAM,CAAC,QAAQ,IAAI,CAAC,eAAC,CAAC,qBAAO,CAAC,gBAAgB,SAAS,CAAC"}`
};
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	$$unsubscribe_page();
	return `<nav class="${'pb-8 flex flex-col md:flex-row items-center'}"><div class="${'flex-1'}"><a href="${'/'}" class="${'svelte-rjamyi'}"><div class="${'logo-wrapper svelte-rjamyi'}"><h1 class="${'logo pr-4 text-3xl svelte-rjamyi'}">Bethany Collins</h1></div></a></div>
	<div class="${'flex-1 flex md:justify-end'}"><a class="${'pr-4 font-display svelte-rjamyi'}" href="${'/flowers'}"><span class="${[
		'svelte-rjamyi',
		$page.path.includes('/flowers') ? 'active' : ''
	]
		.join(' ')
		.trim()}">Florals</span><span class="${'emoji pl-4 svelte-rjamyi'}">\u{1F338}</span></a>
		<a class="${'px-4 font-display svelte-rjamyi'}" href="${'/projects'}"><span class="${[
		'svelte-rjamyi',
		$page.path.includes('/projects') ? 'active' : ''
	]
		.join(' ')
		.trim()}">Projects</span><span class="${'emoji pl-4 svelte-rjamyi'}">\u{1F5C2}</span></a></div>
</nav>`;
});
var css$c = {
	code: 'footer.svelte-1on0ywh{min-height:12em}',
	map: '{"version":3,"file":"Footer.svelte","sources":["Footer.svelte"],"sourcesContent":["<script>\\n</script>\\n\\n<footer></footer>\\n\\n<style lang=\\"scss\\">footer{min-height:12em}</style>\\n"],"names":[],"mappings":"AAKmB,qBAAM,CAAC,WAAW,IAAI,CAAC"}'
};
var Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	$$result.css.add(css$c);
	return `<footer class="${'svelte-1on0ywh'}"></footer>`;
});
var css$b = {
	code: '.body-wrapper.svelte-1727yap{padding:1em}',
	map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script lang=\\"ts\\">import Seo from '$lib/Seo.svelte';\\nimport Nav from '$lib/Nav.svelte';\\nimport Footer from '$lib/Footer.svelte';\\nimport '../app.postcss';\\nimport '../style.scss';\\nimport { browser } from '$app/env';\\nimport lazyload from 'vanilla-lazyload';\\nif (browser && !document.lazyloadInstance) {\\n    document.lazyloadInstance = new lazyload();\\n}\\n<\/script>\\n\\n<Seo />\\n<div class=\\"body-wrapper container mx-auto\\">\\n\\t<Nav />\\n\\t<slot />\\n\\t<Footer />\\n</div>\\n<style lang=\\"scss\\">.body-wrapper{padding:1em}</style>"],"names":[],"mappings":"AAkBmB,4BAAa,CAAC,QAAQ,GAAG,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	$$result.css.add(css$b);
	return `${validate_component(Seo, 'Seo').$$render($$result, {}, {}, {})}
<div class="${'body-wrapper container mx-auto svelte-1727yap'}">${validate_component(
		Nav,
		'Nav'
	).$$render($$result, {}, {}, {})}
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `<div class="${'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4'}"><div class="${'col-start-1 flex items-center justify-center mt-8 mb-16'}"><img class="${'rounded-full mx-auto'}"${add_attribute(
		'src',
		profile,
		0
	)} alt="${'profile image'}"></div>
	<div class="${'md:col-start-2 lg:col-span-3 lg:px-8'}"><p>Hi, I&#39;m Bethany</p>
		...
		<ul><li>See my full <a href="${'/resume.pdf'}" target="${'_blank'}">\u{1F4C4} resume</a></li>
			<li>View my <a href="${'https://www.linkedin.com/in/bethanymariecollins/'}" target="${'_blank'}">\u{1F3E2} LinkedIn</a></li>
			<li>Send me an <a href="${'mailto:bethanywilsoncollins@gmail.com'}" target="${'_blank'}">\u{1F4E9} email</a></li></ul></div></div>`;
});
...
var ga_presentation_mp4 = '/_app/assets/ga_presentation_mp4-494f1c1b.mp4';
var ga_presentation_webm = '/_app/assets/ga_presentation_webm-9758289f.webm';
...
var Tabs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<ul class="${'svelte-19qzbvt'}">${
		(items == null ? void 0 : items.length)
			? `${each(
					items,
					(item) => `<li class="${
						escape(null_to_empty(activeTabValue === item.value ? 'active' : '')) + ' svelte-19qzbvt'
					}"><span class="${'svelte-19qzbvt'}">${escape(item.label)}</span>
			</li>`
			  )}`
			: ``
	}
...
var LightboxThumbnail = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${'clickable svelte-1geqjqc'}"><div class="${[
		...
		.join(' ')
		.trim()}"${add_attribute('style', style2, 0)}>${slots.default ? slots.default({}) : ``}</div>
</div>`;
});
var css$8 = {
...
var LightboxHeader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${[
		...
		.trim()}">${
		closeButton
			? `<button${add_attribute('size', size, 0)}${add_attribute('style', style2, 0)} class="${[
...
var LightboxBody = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	imageClass = `${image.class ? image.class : ''} ${imagePreset ? imagePreset : ''}`;
	{
		if (fullscreen && !(image == null ? void 0 : image.src)) getFullscreenSrc();
	}
	...
	return `<div class="${[
		...
		.trim()}"${add_attribute(
		'style',
		fullscreen ? `background-image: url(${image.src || ''})` : '',
		0
	)}>${
		!fullscreen && image.src
			? `<img${add_attribute('src', image.src, 0)}${add_attribute(
					'alt',
					image.alt,
					0
			  )}${add_attribute('style', image.style, 0)}${add_attribute('class', imageClass, 0)}>`
			: `<div class="${[
					'svelte-u5033r',
					(portrait ? 'svelte-lightbox-image-portrait' : '') +
						' ' +
						(imagePreset == 'expand' ? 'expand' : '') +
						' ' +
						(imagePreset == 'fit' ? 'fit' : '') +
						' ' +
						(fullscreen ? 'fullscreen' : '')
					...
					.join(' ')
					.trim()}"${add_attribute('this', imageParent, 0)}>${
					slots.default ? slots.default({}) : ``
			  }</div>`
	}
</div>`;
...
var LightboxFooter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${
		escape(null_to_empty('svelte-lightbox-footer ' + classes)) + ' svelte-11qpfhu'
	}"${add_attribute(
		'style',
		style2,
		0
...
var ModalCover = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if (
		...
		$$bindings.transitionDuration &&
		transitionDuration !== void 0
	)
		$$bindings.transitionDuration(transitionDuration);
	$$result.css.add(css$5);
	return `<div class="${'svelte-k5ylur'}">${
		slots.default
			? slots.default({})
			: `
    `
...
var Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	$$unsubscribe_activeImageStore = subscribe(
		activeImageStore,
		(value) => ($activeImageStore = value)
	);
	let actualTitle;
	...
	do {
		...
		$$rendered = `${validate_component(ModalCover, 'ModalCover').$$render(
			$$result,
			{ transitionDuration },
			{
			...
			},
			{
				default: () =>
					`${validate_component(Modal, 'Modal').$$render(
						...
						{
							default: () => `${validate_component(LightboxHeader, 'Header').$$render(
								$$result,
        ...
        ${validate_component(LightboxBody, 'Body').$$render(
					$$result,
					{
						imagePreset,
						fullscreen,
        ...
        ${validate_component(LightboxFooter, 'Footer').$$render(
					$$result,
					{
...
var InternalGallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	const arrowsColorStore = new writable('black');
	$$unsubscribe_arrowsColorStore = subscribe(
		arrowsColorStore,
		(value) => ($arrowsColorStore = value)
	);
	const arrowsCharacterStore = new writable('unset');
	$$unsubscribe_arrowsCharacterStore = subscribe(
		arrowsCharacterStore,
		(value) => ($arrowsCharacterStore = value)
	);
	const keyboardControlStore = new writable(false);
...
<div class="${['wrapper svelte-1dny0cf', fullscreen ? 'fullscreen' : '']
		.join(' ')
		.trim()}" style="${'--svelte-lightbox-arrows-color: ' + escape(galleryArrowsColor)}">
    <button ${galleryArrowsCharacter !== 'loop' && activeImage === 0 ? 'disabled' : ''} class="${[
		...
		.join(' ')
		.trim()}"><svg viewBox="${'0 0 24 24'}" xmlns="${'http://www.w3.org/2000/svg'}" class="${'svelte-1dny0cf'}"><g><path class="${'arrow svelte-1dny0cf'}" d="${'M8.7,7.22,4.59,11.33a1,1,0,0,0,0,1.41l4,4'}"></path></g></svg></button>

    
    <div class="${'slot svelte-1dny0cf'}"${add_attribute('this', slotContent, 0)}>${
		slots.default
			? slots.default({})
			: `
        `
    ...
    <button ${
			galleryArrowsCharacter !== 'loop' &&
			activeImage === (images == null ? void 0 : images.length) - 1
				? 'disabled'
				: ''
		} class="${[
		...
		.join(' ')
		.trim()}"><svg viewBox="${'0 0 24 24'}" xmlns="${'http://www.w3.org/2000/svg'}" class="${'svelte-1dny0cf'}"><g><path d="${'M15.3,16.78l4.11-4.11a1,1,0,0,0,0-1.41l-4-4'}" class="${'arrow svelte-1dny0cf'}"></path></g></svg></button>
</div>`;
});
var BodyChild = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div${spread([escape_object($$restProps)])}${add_attribute('this', targetElement, 0)}>${
		slots.default ? slots.default({}) : ``
	}</div>`;
});
var Lightbox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if (
		$$props.thumbnailClasses === void 0 &&
		$$bindings.thumbnailClasses &&
		thumbnailClasses !== void 0
	)
	...
	do {
		$$settled = true;
		$$rendered = `${validate_component(LightboxThumbnail, 'Thumbnail').$$render(
			$$result,
			{
				thumbnailClasses,
				thumbnailStyle,
			...
			},
			{
				default: () =>
					`${
						thumbnail || gallery
							? `${slots.thumbnail ? slots.thumbnail({}) : ``}`
							: `${slots.default ? slots.default({}) : ``}`
					}`
			}
		)}
...
${
	isVisible
		? `${validate_component(BodyChild, 'BodyChild').$$render(
				$$result,
				{},
				{},
				{
					default: () =>
						`${validate_component(Index, 'Modal').$$render(
							$$result,
							{
								modalClasses,
								modalStyle,
								...
								default: () =>
									`${
										thumbnail
											...
											: `${
													gallery
														? `${validate_component(InternalGallery, 'InternalGallery').$$render(
																$$result,
																{ imagePreset },
																{},
																{
																	default: () => `${
																		$$slots.thumbnail
																			? `<div>${slots.thumbnail ? slots.thumbnail({}) : ``}</div>`
																			: ``
																	}
					${
						slots.default
...
<div class="${'py-4'}">${
			currentTab === 1
				? `<p>I recently completed a ten week class in <a href="${'https://generalassemb.ly/education/product-management/los-angeles'}">Product Management at General Assembly</a>. I have created a prototype for a new e-commerce site that allows customers to discover and
			order from local floral designers. Through the class I&#39;ve gained experience with the
			development life cycle: ideation, user interviews/research, creating high and low fidelity
			mockups, testing and validating assumptions, prioritizing features, implementing agile
			strategies, creating a product roadmap, exploring user stories, and writing acceptance
		...
		My product is called<em>\xA0Florage</em>, a creator marketplace for florists. Though it does not
		exist in reality (or not yet at least), it was created as if it would be funded and passed off
		to a development team next.
		<h3 class="${'py-4'}">Final presentation video</h3>
		<video controls><source${add_attribute(
			'src',
			ga_presentation_mp4,
			0
		)} type="${'video/mp4'}"><source${add_attribute(
						'src',
						ga_presentation_webm,
						0
				  )} type="${'video/webm'}">
			Your browser does not support the video tag.
		</video>
		...
		<h3 class="${'pb-4 pt-8'}">Documents</h3>
		<div class="${'horizontal-snap svelte-1pcdv89'}">${each(
						gaDocs,
						(gaDoc) =>
							`<img${add_attribute(
								'src',
								gaDoc,
								0
							)} alt="${'Table Arrangement'}" class="${'svelte-1pcdv89'}">`
				  )}</div>
	...
	${
		currentTab === 2
			? `<p>I&#39;m an ongoing consultant for <a href="${'https://hitrecord.org/classes'}">HitRecord Class Projects</a>. This role is centered around pedagogical/e-learning practices that help make learning
			engaging for adults. Regardless of whether a class is for fun or academia, or for kids or
			adults, these practices are important and I&#39;m happy to have helped with some of the classes
			shown.
		</p>

		<div class="${'my-8'}"><img class="${'grid place-items-center'}"${add_attribute(
					'src',
					hitrecord_collage,
					0
			  )} alt="${'HitRecord Collage Illustration'}"></div>`
			: ``
	}
</div>`;
	} while (!$$settled);
...
var dinner_party_1 = '/_app/assets/party_1-55220224.jpg';
var dinner_party_2 = '/_app/assets/party_2-66186ad4.jpg';
var dinner_party_3 = '/_app/assets/party_3-4e4f3c60.jpg';
var dinner_party_4 = '/_app/assets/party_4-d5e8ce56.jpg';
var dinner_party_5 = '/_app/assets/party_5-5d392854.jpg';
var dinner_party_6 = '/_app/assets/party_6-ca82ae98.jpg';
var dinner_party_7 = '/_app/assets/party_7-c81f32f0.jpg';
var table_arrangement_1 = '/_app/assets/table_arrangement_1-778e89c0.jpg';
var table_arrangement_2 = '/_app/assets/table_arrangement_2-851b8fef.jpg';
var table_arrangement_3 = '/_app/assets/table_arrangement_3-56566294.jpg';
var table_arrangement_4 = '/_app/assets/table_arrangement_4-a2195b33.jpg';
var table_arrangement_5 = '/_app/assets/table_arrangement_5-3a46ae4c.jpg';
var table_arrangement_6 = '/_app/assets/table_arrangement_6-35f61f41.jpg';
var table_arrangement_7 = '/_app/assets/table_arrangement_7-bf1b34df.jpg';
var table_arrangement_8 = '/_app/assets/table_arrangement_8-10bdf280.jpg';
var table_arrangement_9 = '/_app/assets/table_arrangement_9-7491acc7.jpg';
var table_arrangement_10 = '/_app/assets/table_arrangement_10-c7a05ed6.jpg';
var wedding_1 = '/_app/assets/wedding_1-f40a7d78.jpg';
var wedding_2 = '/_app/assets/wedding_2-ba5503d3.jpg';
var wedding_3 = '/_app/assets/wedding_3-0913d4bf.jpg';
var wedding_4 = '/_app/assets/wedding_4-e508e271.jpg';
var wedding_5 = '/_app/assets/wedding_5-6bbfaddf.jpg';
var wedding_6 = '/_app/assets/wedding_6-647df334.jpg';
var wedding_7 = '/_app/assets/wedding_7-6b94ce60.jpg';
var wedding_8 = '/_app/assets/wedding_8-42ad484b.jpg';
var wedding_9 = '/_app/assets/wedding_9-9b767ab3.jpg';
var wedding_10 = '/_app/assets/wedding_10-7efb1225.jpg';
var wedding_11 = '/_app/assets/wedding_11-aa2da439.jpg';
var wedding_12 = '/_app/assets/wedding_12-9c67b3dc.jpg';
var making_1 = '/_app/assets/making_1-0c16010c.jpg';
var making_2 = '/_app/assets/making_2-014b7874.jpg';
var making_3 = '/_app/assets/making_3-1a9f20f9.jpg';
var making_4 = '/_app/assets/making_4-5637daa0.jpg';
var css$1 = {
	code: '.horizontal-snap.svelte-1pcdv89.svelte-1pcdv89{display:grid;gap:1rem;grid-auto-flow:column;height:calc(320px + 1rem);margin:0 auto;overflow-y:auto;overscroll-behavior-x:contain;padding:1rem;-ms-scroll-snap-type:x mandatory;scroll-snap-type:x mandatory}.horizontal-snap.svelte-1pcdv89 img.svelte-1pcdv89{max-width:none;-o-object-fit:contain;object-fit:contain;scroll-snap-align:center;width:220px}',
	map: `{"version":3,"file":"flowers.svelte","sources":["flowers.svelte"],"sourcesContent":["<script lang=\\"ts\\">import dinner_party_1 from '$lib/assets/parties/party_1.jpg';\\nimport dinner_party_2 from '$lib/assets/parties/party_2.jpg';\\nimport dinner_party_3 from '$lib/assets/parties/party_3.jpg';\\nimport dinner_party_4 from '$lib/assets/parties/party_4.jpg';\\nimport dinner_party_5 from '$lib/assets/parties/party_5.jpg';\\nimport dinner_party_6 from '$lib/assets/parties/party_6.jpg';\\nimport dinner_party_7 from '$lib/assets/parties/party_7.jpg';\\nimport table_arrangement_1 from '$lib/assets/table_arrangement/table_arrangement_1.jpg';\\nimport table_arrangement_2 from '$lib/assets/table_arrangement/table_arrangement_2.jpg';\\nimport table_arrangement_3 from '$lib/assets/table_arrangement/table_arrangement_3.jpg';\\nimport table_arrangement_4 from '$lib/assets/table_arrangement/table_arrangement_4.jpg';\\nimport table_arrangement_5 from '$lib/assets/table_arrangement/table_arrangement_5.jpg';\\nimport table_arrangement_6 from '$lib/assets/table_arrangement/table_arrangement_6.jpg';\\nimport table_arrangement_7 from '$lib/assets/table_arrangement/table_arrangement_7.jpg';\\nimport table_arrangement_8 from '$lib/assets/table_arrangement/table_arrangement_8.jpg';\\nimport table_arrangement_9 from '$lib/assets/table_arrangement/table_arrangement_9.jpg';\\nimport table_arrangement_10 from '$lib/assets/table_arrangement/table_arrangement_10.jpg';\\nimport wedding_1 from '$lib/assets/wedding/wedding_1.jpg';\\nimport wedding_2 from '$lib/assets/wedding/wedding_2.jpg';\\nimport wedding_3 from '$lib/assets/wedding/wedding_3.jpg';\\nimport wedding_4 from '$lib/assets/wedding/wedding_4.jpg';\\nimport wedding_5 from '$lib/assets/wedding/wedding_5.jpg';\\nimport wedding_6 from '$lib/assets/wedding/wedding_6.jpg';\\nimport wedding_7 from '$lib/assets/wedding/wedding_7.jpg';\\nimport wedding_8 from '$lib/assets/wedding/wedding_8.jpg';\\nimport wedding_9 from '$lib/assets/wedding/wedding_9.jpg';\\nimport wedding_10 from '$lib/assets/wedding/wedding_10.jpg';\\nimport wedding_11 from '$lib/assets/wedding/wedding_11.jpg';\\nimport wedding_12 from '$lib/assets/wedding/wedding_12.jpg';\\nimport making_1 from '$lib/assets/making/making_1.jpg';\\nimport making_2 from '$lib/assets/making/making_2.jpg';\\nimport making_3 from '$lib/assets/making/making_3.jpg';\\nimport making_4 from '$lib/assets/making/making_4.jpg';\\nimport { Lightbox } from 'svelte-lightbox';\\nconst weddings = [\\n    wedding_1,\\n    wedding_2,\\n    wedding_3,\\n    wedding_4,\\n    wedding_5,\\n    wedding_6,\\n    wedding_7,\\n    wedding_8,\\n    wedding_9,\\n    wedding_10,\\n    wedding_11,\\n    wedding_12\\n];\\nconst tableArrangements = [\\n    table_arrangement_1,\\n    table_arrangement_2,\\n    table_arrangement_3,\\n    table_arrangement_4,\\n    table_arrangement_5,\\n    table_arrangement_6,\\n    table_arrangement_7,\\n    table_arrangement_8,\\n    table_arrangement_9,\\n    table_arrangement_10\\n];\\nconst dinnerParties = [\\n    dinner_party_1,\\n    dinner_party_2,\\n    dinner_party_3,\\n    dinner_party_4,\\n    dinner_party_5,\\n    dinner_party_6,\\n    dinner_party_7\\n];\\nconst makings = [\\n    making_1,\\n    making_2,\\n    making_3,\\n    making_4\\n];\\nlet selectedImg;\\nconst handleClick = (parameter) => {\\n    selectedImg = parameter;\\n};\\n<\/script>\\n\\n<h1 class=\\"text-2xl mb-8\\">Florals</h1>\\n<p>\\n\\tI've been a freelance floral designer for the past four years and have designed florals for dozens\\n\\tof weddings, dinner parties, bridal/baby showers, among other events. If you are interested, send me an <a href=\\"mailto:bethanywilsoncollins@gmail.com\\" target=\\"_blank\\">\u{1F4E9} email</a> and I can provide details.\\n</p>\\n<h2 class=\\"pt-8\\">Wedding</h2>\\n<div class=\\"horizontal-snap\\">\\n\\t{#each weddings as wedding}\\n\\t\\t<img src={wedding} alt=\\"Wedding Arrangement\\" on:click={() => handleClick(wedding)} />\\n\\t{/each}\\n</div>\\n<h2 class=\\"pt-8\\">Dinner Party</h2>\\n<div class=\\"horizontal-snap\\">\\n\\t{#each dinnerParties as dinnerParty}\\n\\t\\t<img src={dinnerParty} alt=\\"Table Arrangement\\" on:click={() => handleClick(dinnerParty)} />\\n\\t{/each}\\n</div>\\n<h2 class=\\"pt-8\\">Table Arrangements</h2>\\n<div class=\\"horizontal-snap\\">\\n\\t{#each tableArrangements as tableArrangement}\\n\\t\\t<img\\n\\t\\t\\tsrc={tableArrangement}\\n\\t\\t\\talt=\\"Table Arrangement\\"\\n\\t\\t\\ton:click={() => handleClick(tableArrangement)}\\n\\t\\t/>\\n\\t{/each}\\n</div>\\n<h2 class=\\"pt-8\\">Behind the Scenes Look!</h2>\\n<div class=\\"horizontal-snap\\">\\n\\t{#each makings as making}\\n\\t\\t<img\\n\\t\\t\\tsrc={making}\\n\\t\\t\\talt=\\"Behind the Scenes Flower Making\\"\\n\\t\\t\\ton:click={() => handleClick(making)}\\n\\t\\t/>\\n\\t{/each}\\n</div>\\n<Lightbox isVisible={!!selectedImg}>\\n\\t<img src={selectedImg} />\\n</Lightbox>\\n\\n<style lang=\\"scss\\">.horizontal-snap{display:grid;gap:1rem;grid-auto-flow:column;height:calc(320px + 1rem);margin:0 auto;overflow-y:auto;overscroll-behavior-x:contain;padding:1rem;-ms-scroll-snap-type:x mandatory;scroll-snap-type:x mandatory}.horizontal-snap img{max-width:none;-o-object-fit:contain;object-fit:contain;scroll-snap-align:center;width:220px}</style>\\n"],"names":[],"mappings":"AA0HmB,8CAAgB,CAAC,QAAQ,IAAI,CAAC,IAAI,IAAI,CAAC,eAAe,MAAM,CAAC,OAAO,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,OAAO,CAAC,CAAC,IAAI,CAAC,WAAW,IAAI,CAAC,sBAAsB,OAAO,CAAC,QAAQ,IAAI,CAAC,qBAAqB,CAAC,CAAC,SAAS,CAAC,iBAAiB,CAAC,CAAC,SAAS,CAAC,+BAAgB,CAAC,kBAAG,CAAC,UAAU,IAAI,CAAC,cAAc,OAAO,CAAC,WAAW,OAAO,CAAC,kBAAkB,MAAM,CAAC,MAAM,KAAK,CAAC"}`
};
...
<div class="${'horizontal-snap svelte-1pcdv89'}">${each(
		...
		(wedding) =>
			`<img${add_attribute(
				...
				wedding,
				0
			)} alt="${'Wedding Arrangement'}" class="${'svelte-1pcdv89'}">`
	)}</div>
<h2 class="${'pt-8'}">Dinner Party</h2>
<div class="${'horizontal-snap svelte-1pcdv89'}">${each(
		dinnerParties,
...
<div class="${'horizontal-snap svelte-1pcdv89'}">${each(
		...
		(making) =>
			`<img${add_attribute(
				...
				making,
				0
			)} alt="${'Behind the Scenes Flower Making'}" class="${'svelte-1pcdv89'}">`
	)}</div>
${validate_component(Lightbox, 'Lightbox').$$render(
	$$result,
	{ isVisible: !!selectedImg },
...
var Secondpost = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `${validate_component(BlogLayout, 'Layout_MDSVEX_DEFAULT').$$render(
		$$result,
		Object.assign($$props, metadata$2),
		{},
		{
			default:
...
var metadata$1 = {
	...
	slug: 'firstpost',
	description:
		'Welcome to Earth. It\u2019s hot in the summer and cold in the winter. It\u2019s round and wet and crowded. On the outside, babies, you\u2019ve got a hundred years here.',
	tags: [
		{
			name: 'Svelte Kit',
			link: 'https://kit.svelte.dev/'
...
var Counter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let count = 42;
	return `<button class="${'bg-green-500 hover:bg-green-600 rounded px-4 py-1 my-4 text-white'}">Count: ${escape(
		count
	)}</button>`;
});
var metadata = {
...
var PaginationNav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if (
		$$props.showStepOptions === void 0 &&
		$$bindings.showStepOptions &&
		showStepOptions !== void 0
	)
	...
	return `<div class="${'pagination-nav'}">${each(
		options2,
		(option) => `<span class="${[
			'option',
			(option.type === 'number' ? 'number' : '') +
				' ' +
				(option.type === 'symbol' && option.symbol === PREVIOUS_PAGE ? 'prev' : '') +
				' ' +
				(option.type === 'symbol' && option.symbol === NEXT_PAGE ? 'next' : '') +
				' ' +
				...
				(option.type === 'symbol' && option.symbol === PREVIOUS_PAGE && currentPage <= 1)
					...
					: '') +
				' ' +
				(option.type === 'symbol' && option.symbol === ELLIPSIS ? 'ellipsis' : '') +
				' ' +
...
var Blog = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<main><article><h1 class="${'headline sm:text-xl md:text-3xl lg:text-7xl leading-relaxed font-black font-display mb-4'}">bethanycollins.me
		...
		<div class="${'article-list'}">${each(
		paginatedItems,
		({
			metadata: { title, description, tags, outline, slug },
			path
		}) => `<div class="${'mb-4'}"><a sveltekit:prefetch${add_attribute(
			'href',
			path.replace(/\.[^/.]+$/, ''),
			0
		)}><h2 class="${'text-3xl leading-relaxed'}">${escape(title)}</h2></a>
					<p>${escape(description)}</p>
				</div>`
	)}</div>
		<div class="${'mx-auto'}">${validate_component(PaginationNav, 'PaginationNav').$$render(
		$$result,
		{
